  ...
  return (
    <div className='navbar'>
      <div className='container'>
        ...
        <img src={menu_open} alt="menu_open" width={50} height={50} className='nav-mob-open' onClick={openMenu}/>
        <ul ref={menuRef} className="nav-menu">
          <img src={menu_close} onClick={closeMenu} alt="menu_close" width={24} height={24} className='nav-mob-close' />
